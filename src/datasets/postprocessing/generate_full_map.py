...
if __name__ == "__main__":
    ...
    parser.add_argument("--show-borders", action="store_true", help="Show red hexel borders in the map.")

    parser.add_argument("--title", type=str, default="Canada Burn Probability Map", help="Custom plot title.")

    parser.add_argument("--output", type=str, default=None, help="Save to file instead of showing.")
    ...
    generate_stitched_map(
        ...
        scale=args.scale,
        show_hex_borders=args.show_borders,
        title=args.title,
