...
class WeatherEncoder(nn.Module):
    def __init__(self, input_dim: int = 8, embed_dim: int = 64, pooling_type: str = "attention"):
        super().__init__()
        ...
        # 3. Projector
        self.projector = nn.Sequential(nn.Linear(64, 64), nn.ReLU(inplace=True), nn.Linear(64, embed_dim))
