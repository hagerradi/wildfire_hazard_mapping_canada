...
def get_split_hexel_window(season_cause_stacked_feats:np.ndarray, season_cause_mask:np.ndarray, season_cause_mapping:dict|None, out_dir:str, root_dir:str, hex_id:str, win_h:int=128, win_w:int=128, overlap_ratio:float=0.2, mask_threshold:float=0.5):
    """
