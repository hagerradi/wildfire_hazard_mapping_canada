...
def main():
    ...
    build_weather_table(
        ...
        norm_params_path=save_dir / args.weather_norm_params_file if args.weather_norm_params_file else None,
    )
    ...
    process_fire_size_distribution_table(
        ...
        train_firezone_ids=train_firezone_ids,
        norm_params_path=save_dir / args.fire_size_norm_params_file if args.fire_size_norm_params_file else None,
    )
