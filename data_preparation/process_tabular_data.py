...
def process_fire_size_distribution_table(input_path: Path, output_path: Path):
    ...
    logger.info(f"Processed fire size distribution data saved to {output_path} with shape {df_fire_size_processed.shape} and columns: {df_fire_size_processed.columns.tolist()}")
