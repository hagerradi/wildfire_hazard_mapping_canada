...
from data_preparation.utils import aggregate_csv_by_pattern, process_fire_size_df, find_file_path
...
def main():
    ...
    fire_size_read_path = find_file_path(args.fire_size_input_file, root_dir, save_dir) # Allows for flexibility in where the fire size distribution file is located, since it was generated by Yan and saved in the data_sampling_approach_XYZ folder and I don't want to assume it's in the sampling folder or the raw data folder. It will look in both and use the one it finds first.
