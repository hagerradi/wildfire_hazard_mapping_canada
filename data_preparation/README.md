...
```
In case of national data, use `--mask_scope="actual"`
...
`--scenario_name="FireSpotting"` is used in case of non-national data with multiple scenarios, this matters for fuel rasters as well as output rasters.
