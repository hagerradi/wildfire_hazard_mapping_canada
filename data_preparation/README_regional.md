...
`python -m data_preparation.tabular.fuel_features.generate_fuel_vectors_national --output-dir /network/projects/amlrt/nrcan_wildfires/data/full_data_bp3plus/NWT_data/NWT_data_baselineNWT_data_scenario_baseline_FireSpotting --fuel_types data_preparation/tabular/fuel_features/generate_fuel_vectors_national/Fuel_Types.csv`, you can modify `Fuel_Types.csv` to include more fuel types.
